...
def train_xgb_with_cv(X, y, n_splits=4, n_iter_search=20, random_state=42):
    ...
    for train_idx, test_idx in tscv.split(X):
        ...
        maes.append(mean_absolute_error(y[test_idx], p))
        # cast to float to disambiguate overloaded return types before sqrt
        rmses.append(math.sqrt(float(mean_squared_error(y[test_idx], p))))
